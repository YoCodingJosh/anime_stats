...
function getRandomErrorGif() {
  var gifs = [
    ...
    "https://cdn.codingjosh.com/anime_stats/error/chino_angry.gif",
    ...
    "https://cdn.codingjosh.com/anime_stats/error/rize_angry_with_gun.gif",
...
function getRandomLoadingGif() {
  var gifs = [
    ...
    "https://cdn.codingjosh.com/anime_stats/loading/mio_honda_thinking.gif",
    "https://cdn.codingjosh.com/anime_stats/loading/mio_moe_moe_kyun.gif",
    ...
    "https://cdn.codingjosh.com/anime_stats/loading/rize_blush.gif",
